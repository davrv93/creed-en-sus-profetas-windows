(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("react"), require("prop-types"), require("resize-observer-polyfill"));
	else if(typeof define === 'function' && define.amd)
		define(["react", "prop-types", "resize-observer-polyfill"], factory);
	else if(typeof exports === 'object')
		exports["AudioPlayer"] = factory(require("react"), require("prop-types"), require("resize-observer-polyfill"));
	else
		root["AudioPlayer"] = factory(root["React"], root["PropTypes"], root["ResizeObserver"]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _resizeObserverPolyfill = __webpack_require__(3);

	var _resizeObserverPolyfill2 = _interopRequireDefault(_resizeObserverPolyfill);

	var _arrayFindIndex = __webpack_require__(4);
	...
	var AudioPlayer = function (_React$Component) {
	  ...
	  function AudioPlayer(props) {
	    ...
	    _this.audioProgressResizeObserver = null;
	  ...
	  _createClass(AudioPlayer, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      this.audioProgressResizeObserver = new _resizeObserverPolyfill2.default(this.resizeListener);
